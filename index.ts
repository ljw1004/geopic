...
import { generateImpl, GeoData, asClusters } from './geoitem.js';
...
function renderGeo(geoData: GeoData, map: google.maps.Map, markerLibrary: google.maps.MarkerLibrary): void {
